...
| <a name="input_firewall_controller_allow_source_ranges"></a> [firewall\_controller\_allow\_source\_ranges](#input\_firewall\_controller\_allow\_source\_ranges) | The IP ranges allowed to connect to the Avi Controller. Access from all IP ranges will be allowed by default | `list(string)` | <pre>[<br>  "0.0.0.0/0"<br>]</pre> | no |
